...
function MenuMobile() {
  ...
  return (
    ...
    >
      ...
      <nav className={MenuIsOn?"fixed h-[400px] top-0 mt-[59px] w-full bg-colorMenu/90 z-10 left-0 transition-all duration-300 overflow-hidden":"fixed h-[0px] top-0 mt-[59px] 12 w-full bg-colorMenu/90 left-0 overflow-hidden transition-all duration-500"}>
        <ul>
