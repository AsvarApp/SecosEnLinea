    ...
    >
      ...
      <nav className={MenuIsOn?"fixed h-[345px] w-full bg-colorMenu/90 z-10 left-0 transition-all duration-300 overflow-hidden":"fixed h-[0px] w-full bg-colorMenu/90 left-0 overflow-hidden transition-all duration-500"}>
        <ul>
          ...
          <li><a href="tolima" className="inline-block p-3 outline-1 border-b-purple-700/70 border-l-0 border-r-0 border-t-0 border text-white w-2/4 float-left"><img className="m-auto w-8 h-8 inline-block" src='../toli.webp' alt="Logo de la loteria de tolima colombia" />Tolima</a></li>
